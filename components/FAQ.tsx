...
const faqs = [
  { q: "چت‌نگار از چه سرویس‌های هوش مصنوعی پشتیبانی می‌کند؟", a: "چت‌نگار از OpenAI (GPT-4, GPT-3.5)، Google Gemini، OpenRouter (که دسترسی به بیش از ۱۰۰ مدل مانند Claude و Llama را می‌دهد) و Gap GPT پشتیبانی می‌کند." },
